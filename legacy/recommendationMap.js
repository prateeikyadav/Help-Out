...
const toolRecommendations = {
  ...
  'To do checklist': [
    { name: 'Focus Ritual', path: './Focus%20Ritual/index.html', reason: 'Use pomodoro method to tackle tasks faster' },
  ...
  'Goal Tracker': [
    ...
    { name: 'Focus Ritual', path: './Focus%20Ritual/index.html', reason: 'Execute with focused work sprints' }
  ],
  'Shopping List': [
